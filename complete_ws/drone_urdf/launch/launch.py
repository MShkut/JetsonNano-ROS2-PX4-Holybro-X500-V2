...
def generate_launch_description():
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=os.path.join('/home/mitch/complete_ws/src/drone_urdf/rviz_config/',
        'complete_launch.rviz'
        ),
    ...
    declare_urdf_cmd = DeclareLaunchArgument(
        'urdf_file',
        default_value=os.path.join(bringup_dir, 'urdf', 'holybro_drone.urdf'),
        description='Whether to start RVIZ')
