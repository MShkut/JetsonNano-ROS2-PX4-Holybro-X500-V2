...
class ArucoNode(rclpy.node.Node):
    def __init__(self):
        ...
        self.img_pub = self.create_publisher(Image, self.aruco_image_topic, 10)
        ...
        self.aruco_parameters_sim = cv2.aruco.DetectorParameters_create()
    ...
    def image_callback(self, img_msg):
        ...
        corners, marker_ids, rejected = cv2.aruco.detectMarkers(
            cv_image, self.aruco_dictionary, parameters=self.aruco_parameters_sim
        )
        ...
        self.aruco_image_topic = self.bridge.cv2_to_imgmsg(frame_markers, encoding="bgr8")
            
        self.img_pub.publish(self.aruco_image_topic)
